/*
 Yeni App — FONET Gebelikte Apandisit Hasta Tarayıcı v1.0.2
...
(() => {
  ...
  async function resolveFromFonet(p){
    ...
    setFonetField(controls.doc,controls.byLabel('İlk Tarih'),new Date(2000,0,1));setFonetField(controls.doc,controls.byLabel('Son Tarih'),new Date());setFonetField(controls.doc,controls.tcInput,p.tc);fireClick(controls.query);
